...
export function spectrePath(points = SPECTRE_POINTS, roundness = 0, lean = 1) {
  ...
  points.forEach((start, index) => {
    ...
    const controlX = (start[0] + end[0]) / 2 - dy / length * bulge;
    const controlY = (start[1] + end[1]) / 2 + dx / length * bulge;
